...
- **Author**: `算法`
- **Cover image**: Deep blue tech background, two lines of white bold text "BMS 算法追踪" and date "YYYY-MM-DD" at **equal visual glyph height**, rendered via PIL (see pitfall 22)
